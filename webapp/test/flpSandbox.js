		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IBAN Change App",
									"targetURL": "#comferreroibanchangeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comferreroibanchangeapp-display": {
								"semanticObject": "comferreroibanchangeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ferrero.ibanchangeapp",
									"url": sap.ui.require.toUrl("com/ferrero/ibanchangeapp")
								}
							}
						}
					}
